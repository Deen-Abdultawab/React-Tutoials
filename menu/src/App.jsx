  ...
  return (
   <section className="lg:w-[70%] w-[90%] mx-auto py-[4rem]">
    ...
    <main>
      ...
      <div className="menu-items flex items-center justify-center flex-wrap gap-[2rem]">
        {
          menuItems.map((menu)=>{
            return (
              <article key={menu.id} className="menu-item w-full max-w-[367px] bg-[#FFFFFF] rounded-[4px] shadow-2xl overflow-hidden">
                ...
                <div className="p-[1.5rem]">
                  <div className="flex items-center justify-between mb-[1.2rem]">
                    <h3 className="font-[500] text-[1.2rem] text-[#0F172A] capitalize leading-[1.25rem]">buttermilk pancakes</h3>
                    <span className="bg-[#F59E0B] text-[#FFFFFF] px-[8px] py-[4px] text-[1rem] rounded-[4px]">$15.99</span>
                  </div>
